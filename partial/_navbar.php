<nav class="navbar navbar-expand-lg bg-info">
    <div class="container">
        ...
        <ul class="navbar-nav me-auto">
            <li class="nav-item"><a href="#" class="nav-link">Türkiye</a></li>
            <li class="nav-item"><a href="#" class="nav-link">Yurtdışı</a></li> 
            <li class="nav-item"><a href="#" class="nav-link">Seyahat Önerileri</a></li> 
        </ul>
